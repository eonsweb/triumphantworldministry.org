<section class="py-12 px-4  md:py-20 md:px-20 mx-auto max-w-8xl relative" x-data="leadershipComponent('#founders')" id="founders" x-cloak>

    <!-- Wrapper for top-right buttons -->
    <div class="flex justify-between mb-10 md:mr-20 relative">
        <h1 class="text-2xl text-gray-800">Founders</h1>
    ...
    <div class="swiper church-leadership">
        <div class="swiper-wrapper">
            <template x-for="leader in getLeadersByLevel(1)" :key="leader.id">
        ...
        {{-- <div class="swiper-button-prev absolute! top-10! left-70! z-index-50 bg-gray-800 rounded-full h-[40px]! w-[40px]!  after:text-white after:text-[16px]! disabled:opacity-30 swiper-button-disabled:pointer-events-none">
        </div>
        <div class="swiper-button-next absolute! top-10! z-index-50 bg-gray-800 rounded-full h-[40px]! w-[40px]!  after:text-white after:text-[16px]! ">
        </div> --}}
    </div>
</section>
