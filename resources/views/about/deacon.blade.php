<section id="deacons" class="py-12 px-4  md:py-20 md:px-20 mx-auto max-w-8xl" x-data="leadershipComponent('#deacons')" x-cloak>
    <!-- Wrapper for top-right buttons -->
    <div class="flex justify-between mb-10 md:mr-20 relative">
        <h1 class="text-2xl text-gray-900">Deacons</h1>
    ...
    <div class="swiper church-leadership">
        <div class="swiper-wrapper">
            <template x-for="leader in getLeadersByLevel(3)" :key="leader.id">
                    <div class="swiper-slide" x-show="leader.level === 3">
